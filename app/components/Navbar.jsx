  ...
  return (
    <>
        ...
        <nav className={`w-full fixed px-5 lg:px-8 xl:px-[8%] py-4 flex items-center justify-between z-50 ${isScroll ? 'bg-white bg-opacity-50 backdrop-blur-lg shadow-sm dark:bg-darkTheme dark:shadow-white/20' : ''}`}>
            <a href="#top">
                <Image src={!isDarkMode ?assets.logo : assets.logo_dark} alt="logo"  className='w-28 cursor-pointer mr-14'/>
            </a>
            ...
            <div className='flex items-center gap-4'>
              ...
              <button onClick={()=>setIsDarkMode(prev=>!prev)}>  
                <Image src={!isDarkMode? assets.moon_icon : assets.sun_icon} alt='moon_icon' className='w-6'/>
              </button>
              ...
              Contact <Image src={isDarkMode ? assets.arrow_icon_dark : assets.arrow_icon} alt='arrow_icon' className='w-3' /></a>
